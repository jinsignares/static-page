...
export const Achievements = () => {
  return (
    <div className="achievements-container">
      ...
      <TextBlock>
        <div className="flex w-full max-w-[1200px] flex-col items-start justify-start place-self-end">
          <Typography as="h3" className="capitalize text-dark-blue">
            Building Appliance Rule Amendments
          </Typography>
          <Typography as="p" className="mt-6 text-dark-gray">
